<?php namespace App\Http\Controllers;
	...
	class AdminLokasiController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Desa','name'=>'nama_id','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'tabel_provinsi,nama'];
			$this->form[] = ['label'=>'Kecamatan','name'=>'nama_id','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'tabel_kota,nama','parent_select'=>'provinsi_id'];
